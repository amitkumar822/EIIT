...
export const CCBCoursePage = () => {
  ...
  const testimonials = [
    {
      ...
      name: "Aarav Patel",
      role: "Student",
      content: "The CCB course gave me the confidence to use computers effectively in my college projects and personal work.",
      rating: 5
    },
    {
      id: 2,
      ...
      content: "After completing CCB, I was promoted to handle digital documentation at my workplace. The practical skills were immediately applicable.",
      rating: 4
    },
    {
      id: 3,
      ...
      content: "This course helped me digitize my shop's records and start accepting digital payments. Game changer for my business!",
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "CCB (Computer Concept & Basics) is a foundational computer literacy program designed to teach essential digital skills to beginners with no prior experience."
    },
    {
      question: "Who should take this course?",
      answer: "Absolute beginners, seniors, homemakers, small business owners, or anyone who wants to gain confidence in using computers and the internet."
    },
    {
      question: "What will I learn in CCB?",
      answer: "You'll learn computer fundamentals, operating systems, word processing, spreadsheets, internet basics, email, and digital safety practices."
    },
    {
      question: "Is there any certification?",
      answer: "Yes, upon successful completion, you'll receive a CCB certification recognized by our education partners."
    },
    {
      question: "What are the technical requirements?",
      answer: "No special requirements. We provide all training computers. You just need enthusiasm to learn!"
    }
  ];
  ...
  const modules = [
    {
      ...
      topics: ["Hardware components", "Software types", "Input/Output devices", "Storage concepts"]
    },
    {
      title: "Operating Systems",
      icon: <Laptop className="w-8 h-8" />,
      topics: ["Windows basics", "File management", "System settings", "User accounts"]
    },
    {
      title: "Word Processing",
      icon: <FileText className="w-8 h-8" />,
      topics: ["Document creation", "Formatting text", "Tables & graphics", "Printing documents"]
    },
    {
      title: "Spreadsheets",
    ...
    },
    {
      ...
      topics: ["Web browsing", "Search techniques", "Email management", "Online safety"]
    },
    {
      title: "Digital Lifestyle",
      icon: <Smartphone className="w-8 h-8" />,
      topics: ["Mobile basics", "Digital payments", "Social media", "Cloud storage"]
    }
  ];
  ...
  const FloatingIcons = () => {
    const icons = [
      { icon: <Laptop className="w-8 h-8 text-blue-400" />, position: 'top-20 left-1/4' },
      { icon: <MousePointerClick className="w-8 h-8 text-indigo-400" />, position: 'top-1/3 right-1/4' },
      { icon: <Code className="w-8 h-8 text-purple-400" />, position: 'bottom-1/4 left-1/5' },
      { icon: <Globe className="w-8 h-8 text-teal-400" />, position: 'bottom-20 right-1/3' },
    ];
  ...
  const BlobBackground = () => (
    <div className="absolute inset-0 overflow-hidden opacity-10">
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <path fill="#3B82F6" d="M45.7,-65.2C58.4,-56.9,67.3,-42.1,73.8,-25.8C80.3,-9.5,84.4,8.3,79.6,23.8C74.8,39.3,61.1,52.5,45.2,62.3C29.3,72.1,11.2,78.5,-6.7,86.7C-24.6,94.9,-49.2,104.9,-63.3,95.4C-77.4,85.9,-81,56.9,-77.1,32.9C-73.2,8.9,-61.7,-10.1,-52.6,-28.3C-43.5,-46.5,-36.7,-64,-23.4,-71.8C-10.1,-79.6,9.7,-77.7,25.9,-69.9C42.1,-62.1,54.6,-48.4,45.7,-65.2Z" transform="translate(100 100)" />
      </svg>
    </div>
  );
  ...
  const PatternBackground = ({ color = 'blue' }) => {
    ...
    return (
      <div className={`absolute inset-0 overflow-hidden opacity-20 ${colors[color]}`}>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              >
                Master Computer Basics with <span className="text-blue-300">CCB</span>
              </motion.h1>
              ...
              >
                Your first step into the digital world. Learn essential computer skills from scratch in our beginner-friendly course.
              </motion.p>
                ...
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 rounded-lg">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-blue-100">No prior experience needed</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-green-300 mt-0.5 mr-2 flex-shrink-0" />
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-green-300 mt-0.5 mr-2 flex-shrink-0" />
                      <span className="text-blue-100">Industry-recognized certification</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-green-300 mt-0.5 mr-2 flex-shrink-0" />
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our comprehensive curriculum covers all essential computer skills for beginners
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-center mb-4 text-gray-800">Computer Fundamentals</h3>
              <p className="text-gray-600 text-center relative z-10">
                Understand hardware, software, and basic operations of a computer system.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-center mb-4 text-gray-800">Operating Systems</h3>
              <p className="text-gray-600 text-center relative z-10">
                Master file management, system settings, and user accounts on Windows.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-center mb-4 text-gray-800">Internet & Email</h3>
              <p className="text-gray-600 text-center relative z-10">
                Learn web browsing, search techniques, email, and online safety practices.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-blue-600 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive modules covering all essential aspects of computer basics
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {modules.map((module, index) => (
              ...
              >
                <div className={`p-8 relative overflow-hidden ${index % 3 === 0 ? 'bg-blue-50' : index % 3 === 1 ? 'bg-indigo-50' : 'bg-purple-50'}`}>
                  <div className="absolute top-0 right-0 w-24 h-24 opacity-10">
                    {module.icon}
                  </div>
                  <div className="flex items-center mb-6 relative z-10">
                    <div className={`p-3 rounded-lg mr-4 ${index % 3 === 0 ? 'bg-blue-100 text-blue-600' : index % 3 === 1 ? 'bg-indigo-100 text-indigo-600' : 'bg-purple-100 text-purple-600'}`}>
                      {module.icon}
                    </div>
                  ...
                  <ul className="space-y-3 relative z-10">
                    {module.topics.map((topic, i) => (
                      <li key={i} className="flex items-start">
                        <CheckCircle className={`w-5 h-5 ${index % 3 === 0 ? 'text-blue-500' : index % 3 === 1 ? 'text-indigo-500' : 'text-purple-500'} mt-0.5 mr-2 flex-shrink-0`} />
              ...
              >
                ...
                <div className="flex items-center mb-6">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className={`w-6 h-6 ${i < testimonial.rating ? 'text-yellow-400' : 'text-gray-200'}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                ...
                <div className="flex items-center">
                  <div className={`bg-${index % 3 === 0 ? 'blue' : index % 3 === 1 ? 'indigo' : 'purple'}-100 text-${index % 3 === 0 ? 'blue' : index % 3 === 1 ? 'indigo' : 'purple'}-600 font-semibold w-12 h-12 rounded-full flex items-center justify-center mr-4`}>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-indigo-700 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg className="w-full h-full" viewBox="0 0 1200 400" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M0 100C150 50 350 150 500 100s300-100 450 50 250 150 400 100" 
                  stroke="rgba(255,255,255,0.3)" strokeWidth="2" fill="none" />
            <path d="M0 250C150 200 350 300 500 250s300-100 450 50 250 150 400 100" 
                  stroke="rgba(255,255,255,0.3)" strokeWidth="2" fill="none" />
          </svg>
        </div>
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
              Join our CCB course today and gain the essential computer skills you need.
            </p>
